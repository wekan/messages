...
class LdapMessage {
   ...
   * @property {number} [options.messageId=1] An identifier for the message.
   * @property {number} [options.protocolOp] The tag for the message operation.
   * @property {object[]} [options.controls] A set of LDAP controls to send with
